...
/**
 * shash_table_create - Creates the sorted hash table.
 * @size: The size of a new sorted hash table.
 *
 * Return: If the error occurs - NULL.
 *         Otherwise - pointer to a new sorted hash table.
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
...
/**
 * shash_table_set - Adds the element to a sorted hash table.
...
/**
 * shash_table_get - Retrieve a value associated with
 *                   the key in the sorted hash table.
 * @ht: Pointer to the sorted hash table.
